...
### 3.6 동적 분석
**3.6.1 로그인을 한다**
![요구사항 동적분석(순차다이어그램) 로그인 이미지](../image/요구사항_순차다이어그램_로그인.png "미니 드라이브에 맞춘 요구사항 동적분석(순차) 로그인 다이어그램입니다.")

**3.6.2 파일 및 폴더를 관리한다.**
![요구사항 동적분석(순차다이어그램) 파일 및 폴더 관리 이미지](../image/요구사항_순차다이어그램_파일관리.png "미니 드라이브에 맞춘 요구사항 동적분석(순차) 파일 및 폴더 관리 다이어그램입니다.")

**3.6.3 파일을 공유한다.**
![요구사항 동적분석(순차다이어그램) 파일 공유 이미지](../image/요구사항_순차다이어그램_파일공유.png "미니 드라이브에 맞춘 요구사항 동적분석(순차) 파일 공유 다이어그램입니다.")

**3.6.4 파일 버전을 복원한다.**
![요구사항 동적분석(순차다이어그램) 파일 복원 이미지](../image/요구사항_순차다이어그램_파일복원.png "미니 드라이브에 맞춘 요구사항 동적분석(순차) 파일 복원 다이어그램입니다.")
...
## 7. 요구사항 추적표
| 요구사항 \ 유스케이스 | U_01 | U_02 | U_03 | U_04 |
| :--- | :---: | :---: | :---: | :---: |
| **F-001** | | O | | |
| **F-002** | | O | | |
| **F-003** | | O | | |
